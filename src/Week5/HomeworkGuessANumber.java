...
public class HomeworkGuessANumber {
	public static void main(String[] args)
	{
		...
		{	
			...
			{
				if(number < 0)
					System.out.printf("The number is %d less than random number: %d", number, randomNumber);
				else if(number > 10)
					System.out.printf("The number is %d greater than random number: %d", number, randomNumber);
